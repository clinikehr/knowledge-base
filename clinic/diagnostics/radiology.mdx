...
<Steps>
  <Step title="Order from the consultation">
    Open the [consultation](/clinic/clinical/consultation), go to the **Orders** tab and select the **Imaging** sub-tab. Ordering here keeps the request tied to the encounter and the clinical question behind it.
  </Step>
...
- The requesting clinician sees the report on the patient's [chart](/clinic/clinical/patient-chart).
...
<AccordionGroup>
  <Accordion title="There is no Radiology group in my sidebar">
    Either the diagnostics [care area](/platform/team/care-areas) is off, or your workspace is not on the Enterprise plan. See [Change your plan](/platform/plans/change-plan).
  </Accordion>
