...
**Analytics** is the menu of every report your workspace can open. It is not a menu in the sidebar — the sidebar entry is a single link, and the page it opens _is_ the menu.
...
Four things filter the list: your edition, your plan, your care areas, and your own permissions.
...
Turning a care area off in **Settings → Facility** removes its report along with its navigation group. If the page says **No reports available**, it tells you the same thing: "Reports follow the care areas this clinic runs. Turn one on in Settings → Facility."

<Note>
  A solo practice seeing about nine reports and a hospital seeing six more is the design, not a missing feature. A report is a promise that the data behind it exists, and a solo clinic has no ward, no theatre and no nursing rota to report on. Publishing an empty **Wards** report would be worse than not publishing one.
</Note>

## The two insurance reports

There are two because there are two different insurance systems, and they are not versions of each other:

- **Insurance** (enterprise) reports the in-house claims workflow a hospital runs against its own payers.
- **Insurance Claims** (solo and team) reports electronic claims sent through the clearinghouse — volume, status and what has been paid.

Your plan decides which one exists for you, and you will never see both. See [Insurance](/clinic/insurance/overview).
...
Money is shown in your clinic's own currency — see [Currency](/platform/settings/currency).
...
<AccordionGroup>
  ...
  <Accordion title="A report vanished from the list">
    Three usual causes: a care area was switched off in **Settings → Facility**, the subscription lapsed and every gate fell back to Free, or a permission was changed. See [Care areas](/platform/team/care-areas) and [Staff permissions](/platform/team/permissions).
  </Accordion>

  <Accordion title="I want Wards or Theatre on a solo plan">
    Those reports exist only on the enterprise plan, because the modules behind them do. See [Change your plan](/platform/plans/change-plan).
  </Accordion>
