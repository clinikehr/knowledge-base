...
Step 5 of the [setup checklist](/clinic/get-started). Your booking page is a public web page where anyone with the link can pick a service, pick a time and book themselves in. Until you publish it, the link returns a **Booking Page Not Found** message.
...
<Steps>
  ...
  <Step title="Choose the services visitors can book">
    ...
    If you see **No Services Found** — "You haven't added any appointment services yet." — use **Manage Appointment Services** and go build one first. See [Add the services you offer](/clinic/get-started/services).
  </Step>
...
Book a test appointment through the public page yourself, then cancel it. It is the only way to see what a patient actually sees.
...
Handling the bookings that arrive is covered in [Booking page](/clinic/front-desk/booking-page).
