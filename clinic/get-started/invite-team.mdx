...
<AccordionGroup>
  ...
  <Accordion title="Someone has left">
    Use **Remove Staff** from the row's **Actions** menu. Their clinical records stay — they are part of the patient's chart and the audit trail — but their access ends immediately.
  </Accordion>
</AccordionGroup>
