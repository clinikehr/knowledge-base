...
Step 4 of the [setup checklist](/clinic/get-started). A service is a bookable thing you do — a consultation, a procedure, a therapy session — with a price and a duration. Your booking page lists them, your appointment sheet prices from them, and your invoices bill from them, so this is worth doing before [publishing the booking page](/clinic/get-started/booking-page).
...
<AccordionGroup>
  <Accordion title="I cannot find a colour, deposit or buffer field">
    There are none on the service form. Appointment colour is set per appointment on the booking sheet, and deposits are set on the booking page under **Payment Settings** — see [Publish your booking page](/clinic/get-started/booking-page).
  </Accordion>
