...
Step 6 of the [setup checklist](/clinic/get-started). The step completes when your clinic is on a paid plan that is **active** or **trialing** — so starting the free trial ticks it.
...
<Steps>
  ...
  <Step title="Compare the three self-serve plans">
    ...
    **Enterprise** is not on this page — it is arranged with us. Use [Contact support](/platform/help/contact-support).
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="I need more staff seats, not more features">
    Seats are capped by plan, and on the Clinic & Hospital edition each billable seat is charged monthly. Some roles — supervisor, biller and scheduler — neither count toward the cap nor cost anything. See [Staff seats](/platform/plans/seats).
  </Accordion>
