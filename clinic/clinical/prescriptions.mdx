...
The sub-tab count goes up as you add items, and the order travels to whoever fulfils it. On the enterprise plan that is your own pharmacy unit — see [Dispensing](/clinic/pharmacy/dispensing). Full context for the encounter is in [Run a consultation](/clinic/clinical/consultation).
