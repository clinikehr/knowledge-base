...
<Availability editions={['lims']} plans="All plans" roles="Everyone whose role reaches Billing — Owner, Manager, Receptionist, Biller, Accountant, Doctor. Bench and imaging roles do not." />
