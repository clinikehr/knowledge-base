...
| **Receive & accession** an incoming batch | The same people, at a full laboratory | Permission — **Accession an incoming specimen** covers the act it performs |
| Cancel an outgoing batch | The same people, at the dispatching site | Role → route |
| Reject a specimen once it is on the bench | **Lab Manager**, **Accessioning Clerk**, **Whole lab**, **All sites** | Permission — **Reject an unsuitable specimen** |
