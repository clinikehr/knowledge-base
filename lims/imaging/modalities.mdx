...
**There is no permission for modality setup.** A **Configure analysers and interfaces** toggle sat in the Diagnostics catalogue until August 2026 and no imaging screen ever read it; it was removed. This page is reachable by anyone whose role reaches the Radiology Station, and the paid feature is the only other gate. A **Lab Scientist** does not reach imaging at all, which is a role rule, not a permission.
