...
| --- | --- | --- |
| **Staff Members** card | Everyone in the lab, with **Name**, **Email**, **Specialty**, **Clinical Specialty** and **Last active**. | Everyone with settings access |
...
Select **Set Clinical Specialty** from a colleague's **Actions** menu to choose one **Primary specialty** and any number of **Additional specialties**. The primary specialty appears on the **Clinical Specialty** column and on that person's signature line on reports.
...
- **The referrer portal needs its own permission.** A report reaches a referring clinic when it is signed out — **Verify and authorise results** is the grant that decides that, not a separate release step.
