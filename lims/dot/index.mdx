...
Role decides whether the module opens at all. Permission decides whether a particular act inside it is allowed — and in Diagnostics those permissions are real, grantable switches, not job titles.
...
| Accession an incoming specimen | **Lab Manager**, **Accessioning Clerk**, **Whole lab**, **All sites** | Permission — **Accession an incoming specimen** |
