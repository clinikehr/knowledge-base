...
| Reject an unsuitable specimen (why a row lands **Rejected for Testing**) | **Lab Manager**, **Accessioning Clerk**, **Whole lab**, **All sites** | Permission — **Reject an unsuitable specimen** |
