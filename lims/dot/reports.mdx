...
| Put a report in a referring practice's portal | **Whole lab**, **All sites** | Permission — **Verify and authorise results**; a DOT order appears once its report PDF exists, so there is no separate release act |
