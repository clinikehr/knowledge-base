...
**Forms** is in your sidebar too. Build intake questionnaires, collection consents and your lab's own checklists, share them by link or QR code, and read the answers in one place — see [Forms](/practice/forms/index).

Who sees it depends on their role. Front desk, phlebotomy, bench and imaging staff reach **Forms**; what each person may do there — build, publish, read answers or export them — is set in their permissions. See [Staff and permissions](/lims/settings/staff).
