...
<Availability editions={['clinic']} plans="All paid plans — repeats need a plan with recurring bookings" roles="Any staff member the Front Desk group is shown to" />

Use Out of Office when someone is on leave, a room is being serviced, or the clinic is closed.

<Path steps={['Sidebar', 'Front desk', 'Appointments', 'Create', 'Out of office']} />
