...
The page header carries **Refresh**, **Import**, **Export** and **New Patient**. The filters are not up there: **Patient status** (**Active**, **Inactive**, **Prospective**, **Archived**), **Billing type** (**Self pay**, **Insurance**), **Waitlist** and **Columns** all sit on the table itself, beside the search box. Each filter carries a count while it is on and a **Clear filter** entry; **Clear all** appears once any is set. **Columns** opens a **Visible Columns** list.
