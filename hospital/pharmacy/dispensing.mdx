...
<Availability editions={['clinic']} plans="Enterprise" roles="Prescribers write; pharmacy staff dispense" note="The Pharmacy group only appears when the In-house pharmacy care area is switched on." />
...
The whole group needs the **In-house pharmacy** care area in **Settings → Facility**. See [Care areas](/hospital/get-started/care-areas).

<Path steps={['Sidebar', 'Pharmacy', 'Pharmacy Station']} />

<TaskHeader before="The In-house pharmacy care area switched on, and the medication in stock in your inventory" time="2 minutes" after="A dispensed prescription with stock drawn down against the patient" />
...
| **POS** | The retail counter — see [Sell at the pharmacy counter](/hospital/pharmacy/pos) |
...
<Steps>
  <Step title="Start it">
    Either open the [consultation](/hospital/outpatient/consultation) and use the **Orders** tab, or open **Pharmacy Station** and select **New Prescription**. Prescribing from the consultation keeps the script attached to the encounter that justified it.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="There is no Pharmacy group in my sidebar">
    Either the **In-house pharmacy** [care area](/hospital/get-started/care-areas) is off, or your workspace is not on the Enterprise plan. See [Change your plan](/platform/plans/change-plan).
  </Accordion>
</AccordionGroup>
...
<Columns cols={2}>
  <Card title="The pharmacy counter" icon="/images/icons/cash-register.svg" href="/hospital/pharmacy/pos">
