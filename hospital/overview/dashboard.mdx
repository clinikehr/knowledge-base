...
<Availability editions={['clinic']} plans="All plans" roles="Owners, managers and accountants" note="No care area needed — Dashboard is the first entry in every plan's sidebar" />
