...
<Availability editions={['clinic']} plans="All plans — the hospital report set (Out-patient, Nursing, Wards, Theatre, Diagnostics, Pharmacy, Insurance) is Enterprise" roles="Any staff member; with Role Navigation on, owners, managers and accountants" />
...
The heading reads **Analytics**, and the line beneath counts them for you: "19 reports available for this clinic. Each one covers a period you choose and can be exported."
...
| **Maternity** | Antenatal coverage, deliveries and the PMTCT cascade, by the month each pregnancy was **booked** | — | Maternity |
| **Maternity Activity** | The monthly return — contacts, doses, deliveries, births and postnatal care, by the month each **happened** | — | Maternity |
...
<Steps>
  ...
  <Step title="Set the period">
    A date-range picker sits on the right. **Pick any window** — click a single day for that day alone, or a start day and an end day for a span of any length. It opens on the last thirty days.
  </Step>
