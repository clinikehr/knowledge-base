...
{/* source of truth: components/clinic/ward-admissions/, components/clinic/ward-admissions/chart/, components/clinic/clients-management/client-mail-tab.tsx, lib/ward/header-labels.ts, lib/edition-staff-roles.ts */}
