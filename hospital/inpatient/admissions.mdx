...
Opening the ward is decided by your **role**, and by whether an owner has hidden the **Inpatient** group from that role under [Role navigation](/hospital/settings/role-navigation). What you may *do* inside is decided by **permissions**, granted per person:
