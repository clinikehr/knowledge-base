...
Nine tabs, always in this order: **Overview**, **Chart**, **Results**, **Note**, **Orders**, **Vitals**, **History**, **Mail** and **Files**. A new consultation lands on **Note**; viewing or updating one lands on **Results**.
