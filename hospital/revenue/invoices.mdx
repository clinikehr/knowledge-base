...
<Availability editions={['clinic']} plans="All plans" roles="Any staff member who can open Billing" />
...
Once Billing opens, almost nothing narrows further:

| Action | Who by default | Governed by |
| --- | --- | --- |
| Create and edit an invoice | Anyone who can open Billing | Nothing |
| Record a payment on it | Anyone who can open Billing | Nothing |
| Change a service's price | Anyone who can open Billing | Nothing |
| See the money figures | Anyone who can open Billing | Nothing |
| Void a payment already taken | Owners, managers, accountants only | Enforced on the server — "Only a clinic owner, manager or accountant can void a payment." |
