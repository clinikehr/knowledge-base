...
<Availability editions={['clinic']} plans="Essential and above" roles="Owners and managers only" />
...
| **Packages** · **Gift cards** · **Promo codes** | Prepaid sessions, gift cards and discounts, sold and used at checkout — see [Sell packages, gift cards and promo codes](/hospital/revenue/packages-and-gift-cards) |
...
| --- | --- | --- |
| Open Memberships | Owners and managers | The Essential plan or above |
