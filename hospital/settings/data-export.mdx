...
**Administrative** also holds your calendar: **Calendar Events** (events and Out of Office blocks, with their times and dates), **Event People & Resources** (who and which rooms or equipment each one applies to), **Calendar Tasks**, and **Clinic Locations** (the sites or premises configured under Settings → Locations).
