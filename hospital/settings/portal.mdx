---
title: "Patient portal settings"
description: "Name, brand and publish the secure area where patients sign in — and learn why the green Live button is not a save button."
...
<Availability editions={['clinic']} plans="Essential and above" roles="Owner only to edit" note="Messaging and Notifications tabs: Essential and above" />
...
<TaskHeader
  ...
  after="A published portal patients can sign in to"
/>
...
| --- | --- | --- |
| **Branding** | **Portal Name**, **URL Slug**, **Welcome Message**, logo, colours, font. Both required fields live here | Essential |
| **Appointments** | Whether patients can see, request, reschedule or cancel appointments, and the start times offered | Essential |
| **Messaging** | Secure two-way messaging, including automated replies | Essential |
| **Telehealth** | Whether patients join video visits from the portal, and the video provider | Essential |
| **Documents** | Which documents patients can read, download and sign | Essential |
| **Notifications** | What the portal emails patients about | Essential |
| **Privacy** | Self-registration, identity checks and what a patient may see of their own record | Essential |
...
<AccordionGroup>
  ...
  <Accordion title="An Unlock the Client Portal panel covers everything">
    The portal starts on Essential: "The Client Portal is a premium feature available on our Essential and Team plans." See [Change your plan](/platform/plans/change-plan).
  </Accordion>
