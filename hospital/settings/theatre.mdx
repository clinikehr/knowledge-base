...
<Availability editions={['clinic']} plans="Enterprise" roles="Owner, manager or accountant" note="Needs the Surgical theatre care area, which ships OFF · owner or manager to change anything" />
