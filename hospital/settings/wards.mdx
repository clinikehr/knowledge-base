...
| --- | --- |
| Added a ward | It becomes selectable on the [wards](/hospital/inpatient/wards) screen. Staff must pick a ward **and** then a sub-ward before any beds are shown — until they do, the screen says "Please select a ward first." |
