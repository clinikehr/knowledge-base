...
<Steps>
  ...
  <Step title="Add a ward">
    Select **Add Ward**, enter the **Ward Name**, and add a location if it helps staff find it. Set **What this ward is for** if you know it — you can always come back. Leave **Status** on **Open**. You get "Ward added successfully".
  </Step>
