...
<Availability editions={['clinic']} plans="All plans — Free carries 'Powered by ClinikEHR' branding" roles="Owner or manager" note="Embedding and digital products: Team and above" />
...
| --- | --- | --- | --- |
| Free | 100 (hosted, "Powered by ClinikEHR" branding) | No | No |
...
<AccordionGroup>
  ...
  <Accordion title="A product will not publish">
    You are at your plan's active-product limit — 100 on Free, 1,000 on Essential. Retire something, or upgrade.
  </Accordion>
