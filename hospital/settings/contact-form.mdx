...
<Availability editions={['clinic']} plans="All plans" roles="Owner or manager" note="Embedding: Essential and above · custom fields and raw iframe: Team" />
...
<AccordionGroup>
  ...
  <Accordion title="Embed your form on Essential">
    "The Essential plan lets you drop your contact form right onto your own website. Upgrade to get the embed snippet." The hosted link works on every plan, including Free.
  </Accordion>
  <Accordion title="I cannot add a custom field or reorder the list">
    Custom fields and drag-reordering are a Team feature. On Free and Essential you can rename and hide the six built-in fields.
  </Accordion>
