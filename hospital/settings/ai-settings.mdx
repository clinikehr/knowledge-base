...
<Availability editions={['clinic']} plans="All plans" roles="Owner, manager or accountant" note="Webhook / API trigger: Team and above · agent-to-agent (MCP) access: any paid plan" />
