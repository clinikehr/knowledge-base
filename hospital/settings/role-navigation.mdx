...
<Availability editions={['clinic']} plans="Enterprise" roles="Owner, manager or accountant" note="Owner to change anything — these settings are the owner's to write" />
...
<TaskHeader
  before="Owner access, and a view on what each role actually works in"
  time="10 minutes"
