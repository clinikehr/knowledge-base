...
<Availability editions={['clinic']} plans="Enterprise" roles="Any staff member" note="Needs the Diagnostics care area · with Role Navigation on, no built-in role rule reaches the Lab Station" />
