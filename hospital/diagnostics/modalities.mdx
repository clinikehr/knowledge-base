...
<Availability editions={['clinic']} plans="Enterprise, plus the imaging bridge — which no Clinic & Hospital plan currently carries" roles="Owners, managers, radiologists, radiology technicians and doctors" note="Needs the Diagnostics care area" />
...
| --- | --- | --- |
| See **Modalities** in the sidebar at all | Nobody on a Clinic & Hospital plan today | Plan — the imaging bridge ships with the Diagnostics edition from **Professional Lab** upward |
