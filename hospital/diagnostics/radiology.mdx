...
<Availability editions={['clinic']} plans="Enterprise" roles="Owners, managers, radiologists, radiology technicians and doctors" note="Needs the Diagnostics care area" />
...
**Download PDF** produces the server-generated report — letterhead, patient details, findings, impression and the reporting radiologist's name and licence — the same document [Radiology reports](/hospital/diagnostics/radiology-reports) downloads from the station. It is available once the study has been saved, before and after it is completed.
...
| See payment on a study | Anyone who can open the study | Nothing — a hospital workspace has no permission that hides money |
...
<AccordionGroup>
  ...
  <Accordion title="What does Radiology History show?">
...
{/* source of truth: components/clinic/radiology/, app/u/clinic/radiology/[clinicId]/page.tsx, app/u/clinic/radiology/history/[clinicId]/page.tsx, components/clinic/general/ (patient-history-group-panel.tsx, patient-history-drilldown-sheet.tsx, patient-history-record-cards.tsx), db/actions/radiology-history-grouped.ts */}
