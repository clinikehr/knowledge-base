...
<Availability editions={['pharmacy']} plans="All plans" roles="Owner or manager" note="Starting the trial checks for one of those two roles" />
...
<TaskHeader before="You must be the owner or a manager of the workspace. No card is needed to start the trial" time="2 minutes" after="An active or trialing paid plan, with its features unlocked for your whole team" />
...
Select **Start for free**. The trial runs on the **Professional** plan, needs no card, and gives you full access plus unlimited records for seven days. Only an owner or a manager can start it — anyone else is told so. If you would rather compare first, **Or compare plans** takes you to the chooser.
