...
<AccordionGroup>
  ...
  <Accordion title="The countersignature is deliberately not the manager's">
    **Witness a controlled-drug dispense** belongs to the **Dispensing Supervisor**, and a **Pharmacy Manager** gets everything else _except_ it. A countersignature only means something when it comes from a second, qualified person.
  </Accordion>
</AccordionGroup>
