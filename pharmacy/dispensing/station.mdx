...
| Dispense against stock on **Fill Rx** | Pharmacy Manager, Dispensing Supervisor, Inventory & Purchasing | **Adjust stock counts** |
...
| Receive a delivery into stock | Pharmacy Manager, Inventory & Purchasing | **Receive deliveries into stock** |

A **Pharmacy Manager** deliberately does **not** get the controlled-drug witness by default — that countersignature is a pharmacist's act, not a manager's, and the role bundle leaves it off on purpose.
