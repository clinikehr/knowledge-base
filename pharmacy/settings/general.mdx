...
| **Country** | Where your pharmacy operates, from a searchable list. It decides which electronic signature statement people agree to before signing a document you send. While it is empty, your billing currency decides instead. | Not set |
