...
<AccordionGroup>
  ...
  <Accordion title="The reset is blocked">
    ...
    **Selling to registered customers does not block a reset.** A till sale records who bought an item, not what was administered to whom. Only a vaccination, a ward administration, an adverse-event report or a clinical dispense against a patient refuses the wipe.
  </Accordion>
