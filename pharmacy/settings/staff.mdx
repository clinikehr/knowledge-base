...
| --- | --- | --- |
| **Staff Members** card | The list of everyone in the pharmacy, with **Name**, **Email**, **Specialty**, **Clinical Specialty** and **Last active**. | Everyone with settings access |
...
| **Actions** menu on a row | **Change Specialty**, **Set Clinical Specialty**, **Permissions**, **Require MFA on sign-in**, **Reset two-factor**, **Grant emergency access**, **Remove Staff**. | Owner only |
...
<Steps>
  ...
  <Step title="Review the permissions on 4 Permissions">
    The switches arrive pre-set from the role you chose. A default **Cashier / Till Operator** gets **none of them** — refunds, price overrides and extra discount are the supervisor's authorisation, and since August 2026 the two the cashier used to hold (**Dispense and sell at the till**, **Open the cash drawer**) no longer exist, because nothing ever checked them. Selling at the till is governed by reaching **POS** at all.
  </Step>
...
| Group | Acts |
| --- | --- |
| **Till** | Override the selling price · Discount beyond the set limit · Refund or void a sale |
...
| **Forms** | View forms · Create and edit forms · Publish and close forms · View form responses · Share templates with other clinics · Send documents for signature · Export form responses · Adjust quiz marks · Fill in staff forms |

**Forms** permissions arrived after some people were already set up. Anyone you had already saved in the permissions sheet keeps every **Forms** permission switched on, so nobody lost access they had — switch off whatever someone should not do. A new invite starts from the defaults for the role you choose.

## Set a Clinical Specialty

**Clinical Specialty is different from Specialty.** **Specialty** (the column and the **Change Specialty** action) is what a colleague signed in AS — the role that decides their permissions. **Clinical Specialty** is what they PRACTICE and never changes what they can do.

Select **Set Clinical Specialty** from a colleague's **Actions** menu to choose one **Primary specialty** and any number of **Additional specialties**. The primary specialty appears on the **Clinical Specialty** column and on that person's signature line on notes and reports.
