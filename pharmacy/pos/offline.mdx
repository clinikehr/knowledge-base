...
- **A sale the server actively refuses** — a bad payload, a product it does not recognise — is _not_ retried silently. It goes to **Need review** and waits for a person, because repeating a refused write forever is how quiet data loss happens.
