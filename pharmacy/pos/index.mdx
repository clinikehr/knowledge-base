...
| --- | --- | --- |
| Ring up a sale and complete it | Cashier, Pharmacy Manager, Dispensing Supervisor | **Dispense and sell at the till** |
...
| Cash up and close the trading day | Pharmacy Manager, Dispensing Supervisor | **Cash up and close the day** |

A default **Cashier** holds exactly two of these — **Dispense and sell at the till** and **Open the cash drawer**. Everything else at the counter is somebody else's authorisation, which is the point: the person taking the money is not the person who decides the price or reverses the sale.
