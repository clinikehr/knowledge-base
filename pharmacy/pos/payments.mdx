...
Taking money and *deciding how much* are deliberately different. Taking a tender is not permission-gated at all — **Dispense and sell at the till**, **Open the cash drawer** and **Cash up and close the day** are on the permissions sheet but nothing checks them yet. What *is* checked on the server is the pricing: a default **Cashier** can take every tender in the list but cannot discount, override a price or reverse anything.
