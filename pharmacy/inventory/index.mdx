...
| Receive a delivery | Pharmacy Manager, Inventory & Purchasing | **Receive deliveries into stock** |
| Adjust or waste stock with **Dispense** | Pharmacy Manager, Inventory & Purchasing | **Adjust stock counts** |
| Move stock to another branch | Pharmacy Manager, Inventory & Purchasing | **Transfer stock between branches** |
...
<AccordionGroup>
  ...
  <Accordion title="'Your Free plan includes up to {n} items. Upgrade to a paid plan for unlimited inventory.'">
    You are at your plan's item limit, so **Add item** was refused rather than silently dropped. The **Free plan** strip shows your usage per kind — items, locations, vendors and purchase orders — and **Upgrade for unlimited** removes the caps.
  </Accordion>
