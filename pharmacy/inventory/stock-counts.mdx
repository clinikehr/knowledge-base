...
**Adjust stock counts** is offered on the permissions sheet but nothing in the product reads it yet, so switching it off does not stop anyone who can open **Inventory** from keying or approving an ordinary count.
