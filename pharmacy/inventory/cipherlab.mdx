...
| --- | --- | --- |
| Connect the cradle and collect a transfer | Pharmacy Manager, Inventory & Purchasing | **Adjust stock counts** |
| Assign an unmatched barcode to a product | Pharmacy Manager, Inventory & Purchasing | **Adjust stock counts** |
| **Apply changes to inventory** | Pharmacy Manager, Inventory & Purchasing | **Adjust stock counts** |
...
The countersignature sits with the **Dispensing Supervisor** bundle and not with **Pharmacy Manager** — a controlled count cannot be applied unless somebody holding it is available. Check that before you walk the shelves.
