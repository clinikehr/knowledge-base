...
The **By cashier** scope on **POS Sales** needs the **View per-cashier takings** permission. The till total and _who took it_ are different questions, and only the second is colleague-performance visibility — so the report stays open to everyone and just that tab is gated.
