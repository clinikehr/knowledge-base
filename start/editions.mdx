...
| --- | --- | --- |
| **Plans** | Free, Essential, Team | Enterprise |
...
Clinic & Hospital no longer sells a Starter plan — a small number of clinics who bought it before it was retired keep it; see [Legacy plans](/platform/plans/legacy-plans). Pharmacy's and Diagnostics' own Starter tiers are unaffected and still on sale.

Staff seats work differently between them, and this catches people out:

<Columns cols={2}>
  <Card title="Clinic & Hospital — a few seats are included, then billed" icon="/images/icons/user-plus.svg">
    Essential and Team each include a number of seats in the base price; every seat beyond that is charged monthly. Some roles — supervisor, biller and scheduler — neither count toward the cap nor cost anything.
  </Card>
