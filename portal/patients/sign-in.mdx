...
<Availability editions={['portal']} note="Your clinic must have its portal switched on and your email address on your record — there is no password, and no two-factor step for patients." />
...
<Steps>
  ...
  <Step title="Fetch the code from your email">
    The next screen is headed **Enter your code** and says "If an account exists for &lt;your address&gt;, we've sent it a sign-in code. Enter it below."
