...
<Availability editions={['clinic', 'lims']} plans="Any paid plan — Free is excluded" roles="Owner" note="There is no Client Portal tab in a Pharmacy workspace." />
...
<TaskHeader before="An owner account on any paid plan" time="About five minutes" after="A live portal at your own address, ready for patients to sign in" />
