...
<Availability editions={['clinic', 'lims']} plans="Essential and above" roles="Any staff member who can open a client record" note="Routes 2 and 3 below enable access as a side effect and are not plan-gated." />
