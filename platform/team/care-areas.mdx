...
Theatre and Maternity are the two that start off, because most sites that sign up neither operate nor run an antenatal clinic. If you have a theatre, switch it on before you try to book a case.
...
| **Maternity** | The whole Maternity group — Today's Clinic, the Antenatal Register, Coverage, Labour Ward and Postnatal — and the Maternity report |
