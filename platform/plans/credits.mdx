...
<Availability editions={['clinic']} plans="Every plan has an allowance; the size varies" roles="Any staff member who can open AI Agents" note="A refill pack is charged to the workspace owner's payment method." />
...
<TaskHeader before="Access to the AI Agents page, and a payment card if you are buying a refill" time="2 minutes" after="A visible credit balance, and refill credits that never expire" />
...
<AccordionGroup>
  ...
  <Accordion title="The Top up button is not there">
    You are not on the **AI Agents** page. The card lives there and on **Settings** → **AI Settings**; it is not on the sidebar, and it is not part of a clinical module. AI Agents is Clinic & Hospital only — a pharmacy or diagnostics workspace has no agents and no credit balance.
  </Accordion>
</AccordionGroup>
