...
<AccordionGroup>
  <Accordion title="No Payment History">
    Either nothing has been charged yet — normal on Free — or your filters are excluding it. The empty state distinguishes the two: "No payment history available for your clinics yet." versus "No payments match your current search criteria."
  </Accordion>
