...
<Availability editions={['all']} plans="All plans" roles="Owner" note="The seat counter and the at-capacity warning are shown to the workspace owner only." />
...
<Columns cols={2}>
  <Card title="Clinic & Hospital — a few seats are included, then billed" icon="/images/icons/credit-card.svg">
    Essential and Team each include a number of seats in the base price. Once you pass that number, every extra billable seat is charged **monthly**. Three roles are free and count toward nothing.
  </Card>
...
### Included seats and the cap

| Plan | Included billable seats | Most billable seats |
| --- | --- | --- |
| Essential | 2 | 5 |
| Team | 5 | No cap |
| Enterprise | Negotiated | No cap |

Free carries **1** staff seat and does not take extra seats — a second person needs Essential or above.

Uncapped does not mean free. Team and Enterprise still charge for every seat beyond what is included — they just do not stop you adding another. A workspace still on the legacy Starter plan keeps Starter's own cap; see [Legacy plans](/platform/plans/legacy-plans).
...
### What an extra seat costs

Indicative, in US dollars, per extra clinician per month, once the included seats are used:

| Plan | Included | Each extra seat |
| --- | --- | --- |
| Essential | 2 | \$40 |
| Team | 5 | \$35 |

Monthly and yearly billing are both available. Treat these as indicative — the plan page carries the current pricing, and your own rate is shown on the **Staff Members** card as, for example, "3 of 5 seats used · 2 included · 1 extra at \$40/mo".

<Warning>
  **Inviting a clinician beyond your included seats charges money immediately.** The **Review** step tells you so: "A prorated charge will be applied immediately for the remaining time in your current billing period." The seat is added to your recurring cost from then on. Removing the person later stops the charge; it does not refund the part-month. Inviting a clinician into one of your included seats costs nothing extra.
</Warning>
...
<Columns cols={2}>
  ...
  <Card title="Legacy plans" icon="/images/icons/clock-rotate-left.svg" href="/platform/plans/legacy-plans">
    Seat rules for a workspace still on Starter or an older price.
  </Card>
</Columns>
