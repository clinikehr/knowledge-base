...
- When an agent alerts your team, it chooses a reason and the notice is worded from that reason. Any short note it adds is refused if it contains a name, contact detail, date or record number, because the whole team sees the notice. See [Notices from your AI agents](/platform/settings/notifications#notices-from-your-ai-agents).
