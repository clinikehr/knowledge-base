...
{/* source of truth: components/clinic/agents/agent-builder.tsx (Inspector, McpManager), node-catalog.ts; lib/agents/mail-agent-tools.ts; components/clinic/dashboard/settings/ai-settings.tsx; components/clinic/agents/mcp-expose-settings.tsx */}
