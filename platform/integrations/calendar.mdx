...
- That provider's slots for that period are no longer offered on your [booking page](/clinic/front-desk/booking-page) — check it signed out, as a patient would.
