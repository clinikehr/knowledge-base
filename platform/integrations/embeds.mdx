...
- Submit a test enquiry, or start a test order, and confirm it arrives in ClinikEHR — see [Contacts](/clinic/front-desk/contacts) or [Your store](/clinic/revenue/store).
