...
- Submit a test enquiry, or start a test order, and confirm it arrives in ClinikEHR — see [Contacts](/practice/work/contacts) or [Your store](/practice/money/store).
