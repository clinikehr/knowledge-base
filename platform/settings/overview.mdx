...
<Warning>
  **Clinic type is not your subscription.** Solo Clinic, Team Clinic and Enterprise Clinic are chosen when the workspace is created; Free, Essential, Team and Enterprise are what you pay for. They share two words and decide different things — upgrading to the Enterprise *plan* does not add **Facility**, and a Solo Clinic on the Team plan still has **Insurance Settings**.
</Warning>
