...
<Steps>
  <Step title="Open Settings and stay on General">
    **General** is the first tab, and the one you land on by default. The card is headed **General Information** — "Your clinic's basic information and regional preferences". The label says _clinic_ whichever edition you run.
  </Step>
...
- Download or print an invoice — see [Billing](/practice/money/billing) — and confirm the header shows your name, address and phone.
