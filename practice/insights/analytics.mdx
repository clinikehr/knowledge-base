...
<Note>
  A solo or team practice seeing about nine reports is deliberate, not a missing feature: a report is a promise that the data behind it exists, and a practice has no ward, no theatre and no nursing rota to report on. Hospitals get six further reports, documented in [Hospital reports and analytics](/hospital/executive/analytics).
</Note>
