...
Card details are held by Stripe and never reach ClinikEHR. Connect the account first under **Settings → Online Payments**; until you do, the **Auto Pay** card shows **Connect Stripe to use Auto Pay** and stays inert. See [Billing](/practice/money/billing).
...
<AccordionGroup>
  ...
  <Accordion title="The person I want to book is not in the search">
    They have no client record yet. Use the **Create client** link inside the booking sheet, or add them from **Clients** first — see [Manage your client list](/practice/work/clients).
  </Accordion>
</AccordionGroup>
