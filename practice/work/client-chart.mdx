...
Nine tabs run across the chart, opening on **Overview**:
...
{/* source of truth: components/clinic/clients-management/client-management-form.tsx, client-profile-sidebar.tsx, patient-notes-dock.tsx, sticky-note-sheet.tsx, update-note-sheet.tsx, notes/client-notes-tab.tsx, notes/client-note-editor.tsx, client-vitals-tab.tsx, lib/clinic-nav-registry.ts */}
