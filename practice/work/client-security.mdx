...
<Availability editions={['clinic']} plans="Essential and up" roles="The person who recorded it, the client's care team, or clinic owner/manager to mark or view; every other team member sees only that a sensitive record exists" />
...
- **Only the person who recorded it, the client's care team, and the clinic owner or a manager can open a sensitive record.** This applies even when the client themself is not restricted — sensitivity is a separate lock from the client-level restriction above.
...
<AccordionGroup>
  ...
  <Accordion title="A note shows &quot;Sensitive note&quot; and I can't open it">
    You're not the author, on this client's care team, or the clinic owner/manager. Ask one of them to open it, or to add you to the client's care team if you need ongoing access.
  </Accordion>
