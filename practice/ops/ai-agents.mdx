...
<Availability editions={['clinic']} plans="Essential and above — the builder is closed on Free" roles="Any staff member; the webhook trigger is owner or manager only" note="Agent and Classify steps consume credits" />
...
<Steps>
  ...
  <Step title="Choose what starts it">
    Select the **Start** node and set its **Trigger**: **Manual / Preview** for testing; a **Schedule** of **Every 15 minutes**, **Every 30 minutes**, **Every hour**, **Every day** or **Every week**; **Webhook / API call**; an inbound message (**Inbound SMS**, **WhatsApp**, **email**, **fax** or **phone call (voice)**); or one of around fifty events such as **Appointment booked** — including, under **Forms**, **Form response submitted**, **Screening form result**, **Quiz scored**, **Form stopped accepting responses**, **Form paused for unusual traffic** and **Form invitation expired unanswered**.
  </Step>
...
The limit is reported when you try to deploy past it: "Your Free plan can publish up to 1 agent or automation at a time. Drafts are always unlimited. Upgrade to Essential to publish more." Undeploying one frees the slot, so you can rotate rather than upgrade.
...
| Publish an agent | Any staff member | Plan — Free publishes 1, Essential and above unlimited; drafts are always unlimited |
| Publish a public agent UI | Any staff member | Plan — Free none, Essential 5, Team unlimited |
...
<AccordionGroup>
  ...
  <Accordion title="Deploy failed and mentions my plan">
    You are at your plan's deployed limit: "Your Free plan can publish up to 1 agent or automation at a time. Drafts are always unlimited. Upgrade to Essential to publish more." Undeploy one, or move up a plan.
  </Accordion>
  ...
  <Accordion title="There is no Public UIs button">
    Your plan includes none — "Public Agent UIs are available on the Essential plan and above." See [Publishing agents](/platform/ai/publishing-agents).
  </Accordion>
</AccordionGroup>
