...
The toolbar carries **Receive**, **Dispense**, **Transfer**, **Reports**, **Import**, **Opening stock**, **Export** and **Add item**. Below it, the tabs split the module by question:
...
Three more appear only when your own stock calls for them, not because of your plan: **Validation** for reagent lots, **Vaccines** once you hold a vaccine-type item, and **Ward MAR** if you run wards. When something needs attention a banner sits above the tabs: "\{n\} open inventory alerts — see the Alerts tab."

A brand-new module shows its empty states rather than an error: "No items yet. Add your first product (e.g. Botox 100U vial).", "No stock on hand. Receive a lot to get started." and "No open alerts. You're all stocked up."
...
<Steps>
  <Step title="Open Add item and name it">
    **Name** is required — write it the way your team says it out loud, not as a supplier's product code. **Barcode / UPC (optional)** lets a scanner find it later, and **Look up drug (NDC or name)** pre-fills a medication: "Pick a match to pre-fill — you can still edit everything."
  </Step>
