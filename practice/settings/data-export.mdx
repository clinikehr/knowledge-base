...
<Availability editions={['clinic']} plans="All plans" roles="Owner, manager or accountant · Audit Logs: owner or manager" />
...
**Administrative** also holds your calendar: **Calendar Events** (events and Out of Office blocks, with their times and dates), **Event People & Resources** (who and which rooms or equipment each one applies to), **Calendar Tasks**, and **Clinic Locations** (the sites or branches configured under Settings → Locations).
