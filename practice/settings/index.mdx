...
| --- | --- | --- |
| **PRACTICE** | General Settings · Staff & Teams · Inventory · Notifications · Locations | [General settings](/practice/settings/general) |
...
One tab comes and goes by role: **Calendar Integrations** ("Sync external .ics calendars") is visible to owners and managers only — an accountant will not see it. **Inventory** ("Alerts, dispensing rules & reset") follows the Inventory care area, but that switch only exists on Enterprise and the area ships on, so on a solo or team practice the tab is always there.
...
<Columns cols={2}>
  ...
  <Card title="Locations" icon="/images/icons/map.svg" href="/practice/settings/locations">
    The sites or branches you operate from, for invoices, appointments and the revenue-by-location report.
  </Card>
