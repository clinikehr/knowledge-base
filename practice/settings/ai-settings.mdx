...
<Availability editions={['clinic']} plans="All plans" roles="Owner, manager or accountant" note="Webhook trigger: Team · Agent-to-agent access: Essential and above" />
...
<Path steps={['Sidebar', 'Settings', 'Communications & AI', 'AI Settings']} />
...
| **Agent-to-agent access (MCP)** | Connector URL and access tokens | Lets partners call your published agents. Essential and above |
