...
Open [Appointments](/practice/daily/appointments) and start a new booking. The times offered should match the block you just added, in the slot length you chose, and should skip anything already booked. Then open your public booking page and confirm a client sees the same times.
