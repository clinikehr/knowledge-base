...
<Availability editions={['clinic']} plans="All plans" roles="Owner or manager" note="Building the form: Starter+ · Embedding: Essential+ · Custom fields and full styling: Team" />
