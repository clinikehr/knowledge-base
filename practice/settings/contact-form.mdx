...
<Availability editions={['clinic']} plans="All plans" roles="Owner or manager" note="Embedding: Essential+ · Custom fields and full styling: Team" />
...
| **Add to your website** | The embed snippet. Essential and above | Locked on Free |
