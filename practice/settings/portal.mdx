...
<Availability editions={['clinic']} plans="Essential and above" roles="Owner, manager or accountant can open it; only the owner can change settings" note="Messaging and Notifications tabs: Essential and above" />
...
| --- | --- | --- |
| **Branding** | **Portal Name**, **URL Slug**, logo, colours. Both required fields live here | Essential |
| **Appointments** | Whether clients can see, request, reschedule or cancel appointments | Essential |
| **Messaging** | Secure two-way messaging with your team | Essential |
| **Telehealth** | Whether clients can join video visits from the portal | Essential |
| **Documents** | Which documents clients can read, download and sign | Essential |
| **Notifications** | What the portal emails clients about | Essential |
| **Privacy** | Self-registration, identity checks and what a client may see of their own record | Essential |
...
<AccordionGroup>
  ...
  <Accordion title="An Unlock the Client Portal panel covers everything">
    The portal starts on the Essential plan: "The Client Portal is a premium feature available on our Essential and Team plans." See [Change your plan](/platform/plans/change-plan).
  </Accordion>
