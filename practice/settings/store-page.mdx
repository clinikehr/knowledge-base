...
<Availability editions={['clinic']} plans="All plans — Free carries 'Powered by ClinikEHR' branding" roles="Owner or manager" note="Embedding, digital products and abandoned-cart recovery need Team" />
...
| --- | --- | --- | --- |
| **Free** | Yes | 100 | Hosted, carries "Powered by ClinikEHR" |
| **Essential** | Yes | 1,000 | No ClinikEHR branding |
...
<Warning>
  If your paid plan lapses, the storefront drops to Free's limits — the public address keeps serving, but you are held to 100 active products and the "Powered by ClinikEHR" branding returns until a paid plan is restored.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="I cannot add another product, or cannot list a downloadable one">
    Both are plan limits. Active listings cap at 100 on Free and 1,000 on Essential — deactivate something you no longer sell, or move up a tier for unlimited. Downloads are separate: "Digital products are available on the Team plan. Upgrade to sell downloads." Physical products are unaffected.
  </Accordion>
