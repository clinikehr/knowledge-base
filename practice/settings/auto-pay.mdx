...
<Availability editions={['clinic']} plans="Essential and above" roles="Owner, manager or accountant can open it; only the owner can change Auto Pay" note="Also requires a connected Stripe account" />
