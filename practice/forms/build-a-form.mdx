...
<Note>
  **Full design** is part of the Starter plan and above. On the Free plan you set the colour, the
  ...
  On the Free, Starter and Essential plans the **Powered by ClinikEHR** line stays on every form you
...
When they are, the form's page tells search engines its title, its description and your practice's name, and a shared link shows a card with your colour, your logo and the form's title. The description is the **Search description** from **Design** if you wrote one (Starter plan and above), or otherwise the description under the form's title. On your own forms domain, the address on that domain is the one search engines are given.
