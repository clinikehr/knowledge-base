...
A client's chart has seven tabs — **Overview**, **Billing**, **Measures**, **History**, **Medications**, **Labs** and **Documents & forms**. **Medications** is the one you want; inside, the section is headed **Medications & ePrescribe** — "Manage active prescriptions and send to pharmacies".
...
Refill reminders are paused during an **Out of Office** block unless you switch off **Medication refill reminders** in the block's **Pause automated reminders** section. A paused refill reminder goes out shortly after the block ends, between 8 AM and 8 PM in your clinic's time zone, even if its day has passed. If a client may run out while you are away, switch the pause off for refill reminders before you save the block.
