...
<Availability editions={['clinic']} plans="All plans — Free gets 5 links a month; recordings and AI consult notes need Essential and above" roles="Any clinician" note="The scheduling screen says Patient where the rest of your practice says Client. It is the same list." />
...
| --- | --- | --- |
| Schedule and host a call | Any clinician | Role — any plan; Free is capped at 5 calls a month |
| Record a session | The host | Plan — **Session Recordings**, Essential and above |
| Generate AI consult notes from a recorded session | The host | Plan — Essential and above; the upgrade prompt names Team |
...
<AccordionGroup>
  <Accordion title="Telehealth Consultations Limit Reached">
    Telehealth needs the Essential plan or above; **Recordings** need it too, and the **AI Notes** tab needs Team. Free includes 5 telehealth links a month with no recording or AI notes. See [Change your plan](/platform/plans/change-plan).
  </Accordion>
