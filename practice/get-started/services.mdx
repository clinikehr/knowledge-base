...
<AccordionGroup>
  <Accordion title="I cannot find a colour or deposit field">
    There is no colour field on the service form: appointment colour is set per appointment on the booking sheet. Deposits are on the service form under **Deposits & cancellation fees** (Essential plan and above, with Stripe connected) — see [Deposits and cancellation fees](/practice/settings/appointment-services#deposits-and-cancellation-fees). Buffer time, processing time, options and add-ons are on the service form under **Timing** and **Options & Add-ons** — see [Appointment services](/practice/settings/appointment-services#options-add-ons-and-timing).
  </Accordion>
...
Ongoing catalogue management, including how services drive invoicing, is in [Services](/practice/money/services).
