...
<Availability editions={['clinic']} plans="All plans" roles="Owner, manager or accountant" note="Free holds 1 seat only. Essential includes 3 seats (caps at 5) and Team includes 5 (uncapped); every seat beyond what is included is charged monthly." />
