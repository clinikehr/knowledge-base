...
<Availability editions={['clinic']} plans="All plans" roles="Owner, and any staff member with access to the step's screen" />
...
2. **You pick up a plan on the way in.** Most new practices land on a setup screen offering **Start on the Free plan** (no card, no time limit) or **Try Essential** (\$29.90 for 30 days, card required). Some land on the plan comparison instead. Both are normal. See [Choose a plan](/practice/get-started/choose-plan).
...
| 6 | [Choose a paid subscription plan](/practice/get-started/choose-plan) | 2 min | Any plan is picked — staying on Free, starting the Essential trial, or a paid plan |
...
<Columns cols={2}>
  ...
  <Card title="Choose a plan" icon="/images/icons/credit-card.svg" href="/practice/get-started/choose-plan">
    Stay on Free, try Essential for \$29.90, or go straight to a paid plan.
  </Card>

  <Card title="Complete your clinic profile" icon="/images/icons/building.svg" href="/practice/get-started/practice-profile">
