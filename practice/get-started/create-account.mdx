...
description: "Sign up for a practice workspace, verify your email address, and sign in for the first time."
...
- A setup screen offering **Start on the Free plan** (no card, no time limit) or **Try Essential** (\$29.90 for 30 days, card required) — the usual landing.
- The plan comparison page. Also normal, not an error — pick a plan from there. See [Choose a plan](/practice/get-started/choose-plan).
