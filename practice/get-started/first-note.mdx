...
<Availability editions={['clinic']} plans="All plans" roles="Any clinical staff member" note="AI Rewrite and AI Autocomplete need Starter or above; the AI Note Taker is a separate per-seat add-on." />
