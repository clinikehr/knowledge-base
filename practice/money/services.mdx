...
| --- | --- | --- |
| Open **Services** | Any staff member | Nothing — the page is not role- or permission-gated |
| Add a service or category | Any staff member | Nothing |
| Change a price | Any staff member | Nothing |
| Deactivate a service | Any staff member | Nothing |

The invite sheet carries **Edit service fees** and **Create billing documents** toggles, and the intent behind them is real: the person who maintains the catalogue is not automatically the person who may reprice it. On a solo or team practice they are **recorded rather than enforced** — nothing on this screen reads them, so anyone who can reach Billing can reprice a service.

Treat that as a reason to be deliberate about who you invite, not as a reason to expect a refusal. See [Staff permissions](/platform/team/permissions).
