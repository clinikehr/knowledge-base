...
<Availability editions={['clinic']} plans="Starter and above — Free has no storefront" roles="Owners and managers" note="Needs inventory items to sell and a connected payment account" />
