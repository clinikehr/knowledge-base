...
<Availability editions={['clinic']} plans="All plans — Free carries 'Powered by ClinikEHR' branding" roles="Owners and managers" note="Needs inventory items to sell and a connected payment account" />
...
| --- | --- | --- |
| Free | 100 | Hosted, carries "Powered by ClinikEHR" |
| Essential | 1,000 | No ClinikEHR branding |
...
<AccordionGroup>
  ...
  <Accordion title="I have hit the product limit">
    Free allows 100 active products and Essential 1,000. Deactivate what you are not selling, or move up a plan.
  </Accordion>
