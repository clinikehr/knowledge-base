...
<Availability editions={['clinic']} plans="Essential and above — membership add-ons need Team or above" roles="Owners and managers only" note="Needs a connected payout account that can accept charges" />
...
- **Plan** — Essential or above. Free gets an upgrade panel instead: "Memberships is a premium feature … Available on the Essential and Team plans." Adding **add-ons** needs Team: "Add-ons require the Team plan. Upgrade your plan to create add-ons." See [Change your plan](/platform/plans/change-plan).
...
| **Packages** · **Gift cards** · **Promo codes** | Prepaid sessions, gift cards and discounts, sold and used at checkout — see [Sell packages, gift cards and promo codes](/practice/money/packages-and-gift-cards) |
