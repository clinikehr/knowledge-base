...
<Availability editions={['clinic']} plans="All plans — Free is manual entry, pay-per-use; Essential and above add AI-assisted claims and eligibility" roles="Any staff member" />
...
| --- | --- | --- |
| Open **Insurance** and read every tab | Any staff member | Any plan |
...
| Run an eligibility check, single or **Batch verify** | Any staff member | Plan — pay-per-use on Free, included allowances from Essential |
...
{/* source of truth: components/clinic/insurance-management/insurance-content.tsx, unbilled-tab.tsx, claims-tab.tsx, payments-tab.tsx, analytics-tab.tsx, create-claim-sheet.tsx, components/clinic/dashboard/settings/insurance-settings.tsx, lib/insurance/claim-provider-roles.ts */}
